...
<figure markdown>
  <div style="background:#f5f5f5;border:2px dashed #ccc;border-radius:8px;padding:48px 24px;text-align:center;color:#999;font-size:14px;line-height:2">
    Screenshot coming<br><code style="font-size:12px">docs/assets/screenshots/entity-inspector.png</code>
  </div>
...
<figure markdown>
  <div style="background:#f5f5f5;border:2px dashed #ccc;border-radius:8px;padding:48px 24px;text-align:center;color:#999;font-size:14px;line-height:2">
    Screenshot coming<br><code style="font-size:12px">docs/assets/screenshots/tempo-trace.png</code>
  </div>
...
<figure markdown>
  <div style="background:#f5f5f5;border:2px dashed #ccc;border-radius:8px;padding:48px 24px;text-align:center;color:#999;font-size:14px;line-height:2">
    Screenshot coming<br><code style="font-size:12px">docs/assets/screenshots/loki-logs.png</code>
  </div>
...
<figure markdown>
  <div style="background:#f5f5f5;border:2px dashed #ccc;border-radius:8px;padding:48px 24px;text-align:center;color:#999;font-size:14px;line-height:2">
    Screenshot coming<br><code style="font-size:12px">docs/assets/screenshots/monitor.png</code>
  </div>
...
<figure markdown>
  <div style="background:#f5f5f5;border:2px dashed #ccc;border-radius:8px;padding:48px 24px;text-align:center;color:#999;font-size:14px;line-height:2">
    Screenshot coming<br><code style="font-size:12px">docs/assets/screenshots/slack-alert.png</code>
  </div>
...
<figure markdown>
  <div style="background:#f5f5f5;border:2px dashed #ccc;border-radius:8px;padding:48px 24px;text-align:center;color:#999;font-size:14px;line-height:2">
    Screenshot coming<br><code style="font-size:12px">docs/assets/screenshots/github-issue.png</code>
  </div>
